...
import (
	...
	"github.com/apedem/rod/lib/input"
...
// Doc for environment variables: https://pkg.go.dev/github.com/apedem/rod/lib/defaults
...
// List of cdp API: https://github.com/apedem/rod/tree/master/lib/proto
...
func Example_load_extension() {
	...
	u := launcher.New().
		...
		// You can use XVFB to get rid of it: https://github.com/apedem/rod/blob/master/lib/examples/launch-managed/main.go
		Headless(false).
		MustLaunch()
